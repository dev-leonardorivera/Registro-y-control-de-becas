...
$sql = "UPDATE `estudiantes` SET `tipoCedula`='".$tipoCedula."',`nombreEstudiante`='".$nombreEstudiante."',`apellidoEstudiante`='".$apeliidoEstudiante."',`idCarrera`=".$idCarrera.",`telefono`='".$telefono."',`direccion`='".$direccion."',`becado`='".$becado."' WHERE cedula = ".$cedula."";
