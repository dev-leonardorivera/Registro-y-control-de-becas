...
$sql= "SELECT estudiantes.nombreEstudiante, estudiantes.apellidoEstudiante, estudiantes.cedula, estudiantes.telefono, estudiantes.direccion, estudiantes.becado, carreras.nombreCarreca from estudiantes INNER JOIN carreras on estudiantes.idCarrera = carreras.idCarrera ORDER BY carreras.nombreCarreca;";
